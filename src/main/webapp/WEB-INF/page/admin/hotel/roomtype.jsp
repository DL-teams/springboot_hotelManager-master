    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <table id="dg" title="房型列表" iconCls="icon-man" class="easyui-datagrid" width="100%"
                ...
                <th field="winds" width="100" align="center">窗数量</th>
            ...
            <div id="dlg" class="easyui-dialog" style="width:400px"
                ...
                <form id="fm" novalidate style="margin:0;padding:20px 50px">
                    ...
                    <div style="margin-bottom:10px">
                        <input name="winds" id="n_winds" class="easyui-textbox" required="true"
                               label="窗数量:"
                               style="width:100%">
                    </div>
            ...
            <div id="dlg1" class="easyui-dialog" style="width:400px"
                ...
                <form id="fm1" novalidate style="margin:0;padding:20px 50px">
                    ...
                    <div style="margin-bottom:10px">
                        <input name="winds" id="u_winds" class="easyui-textbox" required="true"
                               label="窗数量:"
                               style="width:100%">
                    </div>
