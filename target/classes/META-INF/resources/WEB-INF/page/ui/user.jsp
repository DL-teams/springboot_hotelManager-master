                    ...
                    $.ajax({
                        ...
                        success: (res) => {
                            ...
                            if (res.ret) {
                                ...
                                localStorage.setItem("customerId", res.data.user.customerId,setTimeout(20000))
                                localStorage.setItem("customerName", res.data.user.customerName,setTimeout(20000))
                                localStorage.setItem("customerPhone", res.data.user.customerPhone,setTimeout(20000))
                                localStorage.setItem("customerCardNumber", res.data.user.customerCardNumber,setTimeout(20000))
